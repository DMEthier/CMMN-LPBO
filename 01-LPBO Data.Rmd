...
LPBO<-LPBO_all %>% select(ProjectCode, survey_year, survey_month, survey_day, species_id, ObservationCount, ObservationCount3, ObservationCount4, ObservationCount5, SpeciesCode)
